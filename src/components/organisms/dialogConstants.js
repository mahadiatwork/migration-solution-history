 ...
 * Used only when Widget_Picklist_Config has no records (or the module is
 * unreachable). Edit records in that CRM module to add, change, or hide
 * Type / Result / Regarding / Duration options without a code change.
 */
